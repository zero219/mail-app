...
public interface SysUserMapper extends BaseMapper<SysUser> {
     ...
     * @return 返回符合条件的记录总数
     */
    int findCount(SysUserQuery query);
     ...
     * @return 返回当前页的数据列表
     */
    List<SysUser> findPageList(@Param("query") SysUserQuery query, @Param("offset") int offset, @Param("limit") int limit);
     ...
     * @return SysUser 实体对象
     */
    List<SysUser> findBatchIds(@Param("ids") List<Long> ids);
